...
/* return status code */
#define LGW_HAL_SUCCESS     LGW_SUCCESS
#define LGW_HAL_ERROR       LGW_ERROR
...
//TODO: we should remove path array.
    char            com_path[8];   /*!> Path to access the COM device to connect to the SX1302 */
};
...
//TODO: we should remove path array.
    char                        spi_path[8];       /*!> Path to access the SPI device to connect to the SX1261 (not used for USB com type) */
