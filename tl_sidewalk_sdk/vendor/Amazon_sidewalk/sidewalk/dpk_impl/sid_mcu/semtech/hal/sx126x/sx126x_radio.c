    ...
    do {
        ...
        if (drv_ctx.modem == SID_PAL_RADIO_MODEM_MODE_LORA) {
            ...
            if (irq_status & SX126X_IRQ_RX_DONE) {
                ...
                HAOJIE_DBG_CHN5_LOW;
                //tlk_printf("radio_rx_packet->rcv_tm1 = %d, %d\r\n ", drv_ctx.radio_rx_packet->rcv_tm.tv_sec, drv_ctx.radio_rx_packet->rcv_tm.tv_nsec);
...
//        if(radio_event == SID_PAL_RADIO_EVENT_RX_DONE) {
//            HAOJIE_DBG_CHN7_HIGH;
//            HAOJIE_DBG_CHN7_LOW;
//        }
