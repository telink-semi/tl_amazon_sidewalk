...
set(SWDR007_DIR "${CMAKE_CURRENT_SOURCE_DIR}/SWDR007_v1-3-1")
# add_subdirectory("${SWDR007_DIR}/swdr007_silabs_lbm_lib")
set(SWDR007_LBM "${SWDR007_DIR}/swdr007_silabs_lbm_lib/smtc_modem_core")
set(SWDR007_PAL "${SWDR007_DIR}/swdr007_silabs_sid_pal_lr11xx")
...
# zephyr_include_directories(${SWDR007_LBM}/../smtc_modem_api)

# hardcoded configurations
target_compile_definitions(smtc_lbm PUBLIC RP2_103 NUMBER_OF_STACKS=1 LR11XX REGION_US_915)
option(CONFIG_REGION_US_915 "Enable US 915MHz region" ON)
...
if(DEFINED PORTING_TEST)
    ...
    set(LBM_SOURCE
        ...
        ${SWDR007_PAL}/RALBSP/ral_lr11xx_bsp.c
    )
