...
if SELECT_TRANSPORT == TRANSPORT_TYPE.BLE:
    # Always use macOS implementation (Bleak) when FORCE_BLEAK is true
    if FORCE_BLEAK or TRANSPORT_LIBRARY == PLATFORM_TYPE.MAC_OS or TRANSPORT_LIBRARY == PLATFORM_TYPE.WINDOWS:
        from .ble.macos.transport import BluetoothTransport as Transport
    elif TRANSPORT_LIBRARY == PLATFORM_TYPE.LINUX:
