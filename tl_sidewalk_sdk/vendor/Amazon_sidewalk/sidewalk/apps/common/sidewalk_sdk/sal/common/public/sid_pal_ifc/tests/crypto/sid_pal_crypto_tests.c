...
TEST(CRYPTO, test_random_number_gen_positive)
{
...
TEST(CRYPTO, test_random_number_gen_invalid_param)
{
...
TEST(CRYPTO, test_hash_positive)
{
    sid_pal_hash_params_t hash_params;
    uint8_t out_buf[64];
...
TEST(CRYPTO, test_hash_invalid_param_sha256)
{
    test_hash_invalid_param(SID_PAL_HASH_SHA256);
}

TEST(CRYPTO, test_hash_invalid_param_sha512)
{
    test_hash_invalid_param(SID_PAL_HASH_SHA512);
}

TEST(CRYPTO, test_hmac_positive)
{
    uint8_t out_buf[64];
    sid_pal_hmac_params_t hmac_params;
...
TEST(CRYPTO, test_hmac_invalid_param_sha256)
{
    test_hmac_invalid_param(SID_PAL_HASH_SHA256);
}

TEST(CRYPTO, test_hmac_invalid_param_sha512)
{
    test_hmac_invalid_param(SID_PAL_HASH_SHA256);
}

TEST(CRYPTO, test_hmac_negative)
{
    uint8_t out_buf[64];
    sid_pal_hmac_params_t hmac_params = {
...
TEST(CRYPTO, test_cmac_positive)
{
...
TEST(CRYPTO, test_cmac_invalid_param)
{
    uint8_t out_buf[16];
    sid_pal_aes_params_t aes_params = {
...
TEST(CRYPTO, test_cmac_invalid_input_combo)
{
    uint8_t out_buf[64];
    sid_pal_aes_params_t aes_params = {
        .algo = SID_PAL_AES_CMAC_128,
...
TEST(CRYPTO, test_cmac_negative)
{
    uint8_t out_buf[64];
    sid_pal_aes_params_t aes_params = {
        .algo = SID_PAL_AES_CMAC_128,
...
TEST(CRYPTO, test_gcm_invalid_params_encrypt)
{
    test_gcm_invalid_params(SID_PAL_CRYPTO_ENCRYPT);
}

TEST(CRYPTO, test_gcm_invalid_params_decrypt)
{
    test_gcm_invalid_params(SID_PAL_CRYPTO_DECRYPT);
}

TEST(CRYPTO, test_gcm_negative)
{
    uint8_t out_buf[64];
    uint8_t out_mac_buf[16];
...
TEST(CRYPTO, test_ctr_invalid_params_encrypt)
{
    test_ctr_invalid_params(SID_PAL_CRYPTO_ENCRYPT);
}

TEST(CRYPTO, test_ctr_invalid_params_decrypt)
{
    test_ctr_invalid_params(SID_PAL_CRYPTO_DECRYPT);
}

TEST(CRYPTO, test_ctr_invalid_input_combo)
{
    uint8_t out_buf[64];
    sid_pal_aes_params_t aes_params = {
        .algo = SID_PAL_AES_CTR_128,
...
TEST(CRYPTO, test_ecc_key_gen_positive)
{
    uint8_t prk[64], puk[64];
...
TEST(CRYPTO, test_ecc_key_gen_invalid_param_ecdh_curve25519)
{
    test_ecc_key_gen_invalid_param(SID_PAL_ECDH_CURVE25519, 32, 32);
}

TEST(CRYPTO, test_ecc_key_gen_invalid_param_eddsa_ed25519)
{
    test_ecc_key_gen_invalid_param(SID_PAL_EDDSA_ED25519, 32, 32);
}

TEST(CRYPTO, test_ecc_key_gen_invalid_param_ecdsa_secp256r1)
{
    test_ecc_key_gen_invalid_param(SID_PAL_ECDSA_SECP256R1, 32, 64);
}

TEST(CRYPTO, test_ecc_ecdh_curve25519_positive)
{
    ecc_ecdh_positive(SID_PAL_ECDH_CURVE25519, 32, 32);
}

TEST(CRYPTO, test_ecc_ecdh_secp256r1_positive)
{
    ecc_ecdh_positive(SID_PAL_ECDH_SECP256R1, 32, 64);
}

TEST(CRYPTO, test_ecc_ecdh_invalid_param_ecdh_curve25519)
{
    test_ecc_ecdh_invalid_param(SID_PAL_ECDH_CURVE25519, 32, 32);
}

TEST(CRYPTO, test_ecc_ecdh_invalid_param_ecdh_secp256r1)
{
    test_ecc_ecdh_invalid_param(SID_PAL_ECDH_SECP256R1, 32, 64);
}

TEST(CRYPTO, test_ecc_ecdh_curve25519_negative)
{
    ecc_ecdh_negative(SID_PAL_ECDH_CURVE25519, 32, 32);
}

TEST(CRYPTO, test_ecc_ecdh_secp256r1_negative)
{
    ecc_ecdh_negative(SID_PAL_ECDH_SECP256R1, 32, 64);
}

TEST(CRYPTO, test_ecc_dsa_ed25519_positive)
{
    ecc_dsa_positive(SID_PAL_EDDSA_ED25519, 32, 32);
}

TEST(CRYPTO, test_ecc_dsa_secp256r1_positive)
{
    ecc_dsa_positive(SID_PAL_ECDSA_SECP256R1, 32, 64);
}

TEST(CRYPTO, test_ecc_dsa_invalid_param_eddsa_ed25519)
{
    test_ecc_dsa_invalid_params(SID_PAL_EDDSA_ED25519, 32, 32);
}

TEST(CRYPTO, test_ecc_dsa_invalid_param_ecdsa_secp256r1)
{
    test_ecc_dsa_invalid_params(SID_PAL_ECDSA_SECP256R1, 32, 64);
}

TEST(CRYPTO, test_ecc_dsa_ed25519_negative)
{
    ecc_dsa_negative(SID_PAL_EDDSA_ED25519, 32, 32);
}

TEST(CRYPTO, test_ecc_dsa_secp256r1_negative)
{
...
{
    RUN_TEST_CASE(CRYPTO, test_random_number_gen_positive);
    RUN_TEST_CASE(CRYPTO, test_random_number_gen_invalid_param);
    RUN_TEST_CASE(CRYPTO, test_hash_positive);
    RUN_TEST_CASE(CRYPTO, test_hash_invalid_param_sha256);
    RUN_TEST_CASE(CRYPTO, test_hash_invalid_param_sha512);
    RUN_TEST_CASE(CRYPTO, test_hmac_positive);
    RUN_TEST_CASE(CRYPTO, test_hmac_invalid_param_sha256);
    RUN_TEST_CASE(CRYPTO, test_hmac_invalid_param_sha512);
    RUN_TEST_CASE(CRYPTO, test_hmac_negative);
    RUN_TEST_CASE(CRYPTO, test_cmac_positive);
    RUN_TEST_CASE(CRYPTO, test_cmac_invalid_param);
    RUN_TEST_CASE(CRYPTO, test_cmac_invalid_input_combo);
    RUN_TEST_CASE(CRYPTO, test_cmac_negative);
    RUN_TEST_CASE(CRYPTO, test_gcm_positive);
    RUN_TEST_CASE(CRYPTO, test_gcm_invalid_params_encrypt);
    RUN_TEST_CASE(CRYPTO, test_gcm_invalid_params_decrypt);
    RUN_TEST_CASE(CRYPTO, test_gcm_negative);
    RUN_TEST_CASE(CRYPTO, test_ctr_positive);
    RUN_TEST_CASE(CRYPTO, test_ctr_invalid_params_encrypt);
    RUN_TEST_CASE(CRYPTO, test_ctr_invalid_params_decrypt);
    RUN_TEST_CASE(CRYPTO, test_ctr_invalid_input_combo);
    RUN_TEST_CASE(CRYPTO, test_ctr_negative);
    RUN_TEST_CASE(CRYPTO, test_ecc_key_gen_positive);
    RUN_TEST_CASE(CRYPTO, test_ecc_key_gen_invalid_param_ecdh_curve25519);
    RUN_TEST_CASE(CRYPTO, test_ecc_key_gen_invalid_param_ecdsa_secp256r1);
    RUN_TEST_CASE(CRYPTO, test_ecc_key_gen_invalid_param_eddsa_ed25519);
    RUN_TEST_CASE(CRYPTO, test_ecc_ecdh_curve25519_positive);
    RUN_TEST_CASE(CRYPTO, test_ecc_ecdh_secp256r1_positive);
    RUN_TEST_CASE(CRYPTO, test_ecc_ecdh_invalid_param_ecdh_curve25519);
    RUN_TEST_CASE(CRYPTO, test_ecc_ecdh_invalid_param_ecdh_secp256r1);
    RUN_TEST_CASE(CRYPTO, test_ecc_ecdh_curve25519_negative);
    RUN_TEST_CASE(CRYPTO, test_ecc_ecdh_secp256r1_negative);
    RUN_TEST_CASE(CRYPTO, test_ecc_dsa_ed25519_positive);
    RUN_TEST_CASE(CRYPTO, test_ecc_dsa_secp256r1_positive);
    RUN_TEST_CASE(CRYPTO, test_ecc_dsa_invalid_param_eddsa_ed25519);
    RUN_TEST_CASE(CRYPTO, test_ecc_dsa_invalid_param_ecdsa_secp256r1);
    RUN_TEST_CASE(CRYPTO, test_ecc_dsa_ed25519_negative);
    RUN_TEST_CASE(CRYPTO, test_ecc_dsa_secp256r1_negative);
}

void sid_pal_crypto_tests_run(void)
{
