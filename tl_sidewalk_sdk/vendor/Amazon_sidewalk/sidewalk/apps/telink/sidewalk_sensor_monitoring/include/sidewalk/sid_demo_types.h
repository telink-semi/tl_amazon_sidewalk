...
enum sid_demo_class_type {
    SID_DEMO_APP_CAP_DISCOVERY_NOTIFICATION = 0x2, // '010'
    SID_DEMO_APP_CAP_DISCOVERY_RESP = 0x3, // '011'
    SID_DEMO_APP_ACTION_REQ = 0x5, //'101'
    SID_DEMO_APP_ACTION_NOTIFICATION = 0x6, //'110'
    SID_DEMO_APP_ACTION_RESP = 0x7 //'111'
};
...
enum sid_demo_tag_id {
    ...
    SID_DEMO_TAG_TEXT_MESSAGE = 0x14,
    SID_DEMO_TAG_IMU_DATA = 0x15,
    SID_DEMO_TAG_LINK_TYPE_SET_ACTION_REQ = 0x16,
    SID_DEMO_TAG_LINK_TYPE_SET_RESP       = 0x17,
    SID_DEMO_TAG_LAST,
...
enum sid_demo_action_resp_type {
    ...
    SID_DEMO_ACTION_TYPE_LINK_TYPE_CHANGE = 3,
...
struct sid_demo_action_notification {
    ...
    uint8_t IMU_data_used;
    uint8_t LEDs_active[APP_NUMBER_OF_LEDS];
    uint8_t number_of_active_LEDs;
    uint32_t gps_time_in_seconds;
    uint32_t file_id;
    enum sid_demo_temperature_sensor temp_sensor;
