...
#define _attribute_iram_bss_                 __attribute__((section(".iram_bss")))
    ...
    #define _attribute_ble_data_retention_
    ...
    #if __PROJECT_SIDEWALK_DEMO__ == 0
        ...
        #define _attribute_ram_ble_data_retention_    __attribute__((section(".ram_data_ble")))    // used for ble
    #endif
#else
    #define _attribute_ram_code_                  __attribute__((section(".ram_code_ble"))) __attribute__((noinline))
    #define _attribute_ram_code_only_             __attribute__((section(".ram_code_ble")))
    ...
    #else
        #define _attribute_ble_ram_code_optimize_o2_            __attribute__((section(".ram_code_ble"))) __attribute__((optimize("O2"))) __attribute__((no_execit))
        #define _attribute_ble_ram_code_optimize_o2_noinline_   __attribute__((noinline)) __attribute__((section(".ram_code_ble"))) __attribute__((optimize("O2"))) __attribute__((no_execit))
    #endif
#else
    #ifndef BLC_ZEPHYR_BLE_INTEGRATION
