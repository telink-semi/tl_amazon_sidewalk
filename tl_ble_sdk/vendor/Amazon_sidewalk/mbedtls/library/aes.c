 ...
 */
__attribute__((section(".retention_data"))) static unsigned char FSb[256];
__attribute__((section(".retention_data"))) static uint32_t FT0[256];
__attribute__((section(".retention_data"))) MBEDTLS_MAYBE_UNUSED static uint32_t FT1[256];
__attribute__((section(".retention_data"))) static uint32_t FT2[256];
__attribute__((section(".retention_data"))) static uint32_t FT3[256];
