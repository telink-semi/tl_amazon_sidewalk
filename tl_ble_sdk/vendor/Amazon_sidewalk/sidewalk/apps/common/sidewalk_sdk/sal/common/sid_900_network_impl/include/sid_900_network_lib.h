...
// 900 MHz memory pool for ctrl_req_msg
#ifndef SID_900_NETWORK_MEMPOOL_SIZE
#define SID_900_NETWORK_MEMPOOL_SIZE (1 * 500)
#endif
...
typedef struct {
    ...
    struct sid_memory_pool *mem_pool_handle;
